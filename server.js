...
// 1. Basic Information
const TOKEN = process.env.BOT_TOKEN || '8747226346:AAEaR3j4s03bYp3-6x4bYytRAAsy8i8cmjw';
...
const PROOF_CHANNEL = '@jossy_pay_proof';
...
async function sendForceJoin(chatId, firstName = "") {
    ...
    const captionMsg = `Hello ${firstName}, Welcome to Jossy pay!\n\nFirst, please join these channels:`;
